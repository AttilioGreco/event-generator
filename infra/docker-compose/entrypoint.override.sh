...
set -euo pipefail
echo "Running entrypoint.override.sh"

# Remove the registry file to prevent filebeat from skipping files that were already processed in a previous run.
rm -rfv /usr/share/filebeat/data/registry
